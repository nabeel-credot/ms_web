...
import styles from "./HowCanHelp.module.css";
...
function HowCanWeHelp() {
  ...
  return (
    <Container>
      <div className={styles.howCanWeHelp_container}>
        <div className={styles.main}>
          <div className={styles.columns} data-aos="fade-right">
            <div className={styles.howCanWeHelp_left}>
          ...
          <div className={styles.columns} data-aos="fade-left">
            <div className={styles.howCanWeHelp_right}>
              <Form>
