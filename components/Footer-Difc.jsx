          ...
          <div className={styles.container}>
            ...
            <div className={styles.coloumn}>
              <div className={styles.box}>
                <div className={styles.titlehead}>Freezone</div>
                ...
                >
                  <div className={styles.mobileicon}> <Image src="/images/adgmfooter.svg" width={25} height={25} alt="ADGM-Icon"/></div>
              ...
              <Link href="/dubai-multi-commodities-centre"><a>
                ...
                >
                <div className={styles.mobileicon}>  <Image src="/images/dmccfooter.svg" width={25} height={25} alt="DMCC-Icon"/></div>
                <span>
              ...
              <div className={styles.box}>
                ...
                >
                 <div className={styles.mobileicon}>  <Image src="/images/difcfooter.svg" width={25} height={25} alt="DIFC-Icon"/></div>
                 <span>
                ...
                <ul className={styles.contactList}>
                  <li>
                    ...
                    <div className={styles.add} style={{ flex: 1 }}>
                      {" "}
                      Level 11, Fortune Tower, Cluster C
                      <br/>
                  ...
                  <li className={styles.colorY}>
                    ...
                    <div className={styles.add}>
                      <Link href="tel: +971 48357270">+971 48357270</Link>
                    </div>
                  </li>
                  <li className={styles.colorY}>
                    {/* <div className={styles.iconA}>
