...
import Collapsible from "../Accounting&Bookkeeping/Collapsiblenew";
import styles from "../Accounting&Bookkeeping/Styles.module.css";
...
<div className={styles.faqtitle}> Frequently Asked Questions (FAQ)</div>
        <div className={`${styles.onlineBookingService_sub} ${styles.faqservice}`}>
          <div className={styles.columns} >
            ...
            <Collapsible
              open={false}
              arrow={true}
              title={"What is the timeframe for setting up ADGM?"}
            >
              <div>
                The entire process typically takes 2-3 weeks, provided that all
                documents are submitted to ADGM. The timeline may vary subject
                to the provisions of any additional information /documentation
                requested by ADGM during the process.
              </div>
            </Collapsible>
