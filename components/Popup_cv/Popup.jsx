...
function RequestCall({ onClick ,id}) {

  const initialValues = { name: "", email: "", resume: "", jobTitle: id };
  ...
  const handleSubmit=async (e)=>{
      ...
      if(Object.keys(errors).length==0){
        setDisableBtn(true)
          ...
          try {
            console.log("formValues",  form.current);
      ...
      <form ref={form} onSubmit={handleSubmit}>
                <div className={styles.form} >
                    ...
                    <input type="text" placeholder='Email' name="email" value={formValues.email}
                        onChange={handleChange} />
                         <input type="text" name="jobTitle" value={"Application for "+id} readOnly className={styles.valueCls}/>
