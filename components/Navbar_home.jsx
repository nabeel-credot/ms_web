      ...
      <div className={toggleActive ? styles.headerNew : styles.header}>
        ...
        <ul className={toggleActive ? styles.menuActive : styles.menu}>
                ...
                <div className={styles.dropdown}>
                  ...
                  <div className={styles.dropdown_content_howMain}>
                    <div className={styles.dropdown_content_how}>
                      <div>
                        <div className={styles.section}>
                          ...
                          <div
                            ...
                            className={styles.list}
                          >
                            <Link href="/valuation" prefetch={false}>
                              Valuation
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className={styles.section}>
                        <div className={styles.dropdownTitle}>
                          <Link href="/Difc_tax_service">Tax</Link>
                        </div>
                        ...
                        <div
                          ...
                          className={styles.list}
                        >
                          <Link href="/difc_tax_subservice_vat" prefetch={false}>
                            VAT Services
                          </Link>
                        </div>
                        ...
                        <div
                          ...
                          className={styles.list}
                        >
                          <Link href="/difc_tax_subservice_ctax" prefetch={false}>
                            Corporate Tax
                          </Link>
                        </div>
                        ...
                        <div
                          ...
                          className={styles.list}
                        >
                          <Link href="/difc_tax_subservice_tp" prefetch={false}>
                            Transfer Pricing
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className={styles.section}>
                        <div
                          ...
                          style={{ width: "90%" }}
                        >
                          <Link href="/Difc_accounting_service" prefetch={false}>
                            <a>Accounting</a>
                          </Link>
                        </div>
                        <div
                          ...
                          className={styles.list}
                        >
                          <Link href="/difc_accounting-_subservice_1" prefetch={false}>
                        ...
                        <div
                          ...
                          className={styles.list}
                        >
                          <Link href="/difc_accounting-_subservice_2" prefetch={false}>
                            Payroll Services
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className={styles.section}>
                        <div className={styles.dropdownTitle}>
                          <Link
                            href="/dubai-multi-commodities-centre"
                            prefetch={false}
                          >
                ...
                <div className={styles.dropdownMob}>
                  ...
                  {dropDown2 ? (
                    <div className={styles.dropdown_mob}>
                      ...
                      >
                        <div className={styles.title}>
                          <Link href="/executivesearchnew" prefetch={false}>
                            Executive Search
                          </Link>
                        </div>
                      ...
                      >
                        <div className={styles.title}>
                          <Link href="/Difc_tax_service" prefetch={false}>
                            Tax
                          </Link>
                        </div>
                        <div
                      ...
                      {dropDown5 ? (
                        <div className={styles.dropdown_mob_sub}>
                          ...
                          >
                            <Link
                              href="/difc_accounting-subservice_1"
                              prefetch={false}
                            >
                              Bookkeeping Services
                            </Link>
                          ...
                          <div
                            ...
                            className={styles.borderBt}
                          >
                            <Link href="/difc_accounting-subservice_2" prefetch={false}>
                              Payroll Services
                            </Link>
                          </div>
                        </div>
          ...
          >
           ...
           ( <Link href="/e-commerce-startup" prefetch={false}>
              <a>
                <div className={styles.smartup}>
                  <Image src="/images/smartup.png" alt="" layout="fill" />
