      ...
      <div className={styles.container} data-aos="fade-up">
        ...
        <div className={styles.serviceWrap}>
          <div className={styles.box}>
            ...
            Understanding client desire & customizing models <br/>accordingly
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>
            Ensuring compliance & <br/>standards
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>
            Anticipates future earnings<br/> and costs
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>
            Establishing budget <br/>allocation
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>
            Consideration of additional<br/> scenarios and alternate<br/> strategies
            </div>
          </div>
