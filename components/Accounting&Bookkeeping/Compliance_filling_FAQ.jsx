          ...
          <div className={`${styles.onlineBookingService_sub} ${styles.faqservice}`}>
            <div className={styles.columns} data-aos="fade-right">
              <Collapsible
                ...
                arrow={true}
                title={
                  "What is the difference DIFC & DFSA ?"
                }
              >
                <div>
                The Dubai International Financial Centre (DIFC) is a special economic zone in Dubai, 
                UAE, while the Dubai Financial Services Authority (DFSA) is the independent regulatory 
                authority responsible for overseeing and regulating financial services conducted within the DIFC. 
                In essence, the DIFC is the physical and legal infrastructure where businesses operate, while the 
                DFSA is the regulatory body ensuring compliance and maintaining financial stability within this zone.
                </div>
              </Collapsible>
