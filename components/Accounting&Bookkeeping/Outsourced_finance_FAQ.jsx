  ...
  <div className={styles.faqtitle} data-aos="fade-right"> Frequently Asked Questions (FAQ)</div>
          <div className={`${styles.onlineBookingService_sub} ${styles.faqservice}`}>
            ...
            <Collapsible
                open={false}
                arrow={true}
                title={"How does finance officers aid in risk management of businesses in DIFC ?"}
              >
                <div>
              ...
              <Collapsible
                open={false}
                arrow={true}
                title={"How can I initiate the process of utilizing your DIFC Finance Officer services ?"}
              >
                <div>
