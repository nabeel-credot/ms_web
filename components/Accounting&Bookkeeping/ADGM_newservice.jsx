...
function ADGM_newservice() {
  return (
    <Container >
      <div className={styles.servicenewTitle} data-aos="fade-up">  <div className={styles.servicelogodifc}> <Image src={"/images/logo3.svg"} alt="logo" layout="fill"/> </div><span style={{paddingTop:"40px"}}>Services in <span style={{fontWeight:"500"}}>ADGM</span></span> </div>
        ...
        <Link href="/corporate-services">
          <div className={styles.imagedivADGM}>
            <div className={styles.servicecircle}>
              ...
              >
                <path d="M34.8333 30.875V35.75H3.16663V30.875C3.16663 29.9812 3.87913 29.25 4.74996 29.25H33.25C34.1208 29.25 34.8333 29.9812 34.8333 30.875Z" />
                <path d="M11.0833 17.875H7.91663V29.25H11.0833V17.875Z" />
                <path d="M17.4167 17.875H14.25V29.25H17.4167V17.875Z" />
                <path d="M23.75 17.875H20.5834V29.25H23.75V17.875Z" />
                <path d="M30.0833 17.875H26.9166V29.25H30.0833V17.875Z" />
                <path d="M36.4167 36.9688H1.58337C0.934207 36.9688 0.395874 36.4162 0.395874 35.75C0.395874 35.0838 0.934207 34.5312 1.58337 34.5312H36.4167C37.0659 34.5312 37.6042 35.0838 37.6042 35.75C37.6042 36.4162 37.0659 36.9688 36.4167 36.9688Z" />
                <path d="M33.8358 9.34374L19.5858 3.49374C19.2691 3.36374 18.7308 3.36374 18.4141 3.49374L4.16413 9.34374C3.60996 9.57124 3.16663 10.2375 3.16663 10.855V16.25C3.16663 17.1437 3.87913 17.875 4.74996 17.875H33.25C34.1208 17.875 34.8333 17.1437 34.8333 16.25V10.855C34.8333 10.2375 34.39 9.57124 33.8358 9.34374ZM19 13.8125C17.6858 13.8125 16.625 12.7237 16.625 11.375C16.625 10.0262 17.6858 8.93749 19 8.93749C20.3141 8.93749 21.375 10.0262 21.375 11.375C21.375 12.7237 20.3141 13.8125 19 13.8125Z" />
              </svg>
            </div>
            <p>Corporate</p>
            <span className={styles.servicedescribe}>
              Discover bespoke corporate solutions designed to elevate your
              business at ADGM with MS. With a proven track record and a commitment to personalized excellence...
              
            </span>
            
  <div style={{ color: "#D4AE31", cursor: "pointer",paddingTop: "25px", paddingBottom:"8px" }}>Read More</div>
