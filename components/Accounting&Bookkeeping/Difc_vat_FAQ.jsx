          ...
          <div className={`${styles.onlineBookingService_sub} ${styles.faqservice}`}>
            <div className={styles.columns} data-aos="fade-right">
              <Collapsible
                ...
                arrow={true}
                title={
                  "What are the Compliance Requirements for VAT in DIFC ?"
                }
              >
                <div>
                Key VAT compliance requirements for DIFC businesses include maintaining accurate records, issuing tax invoices, filing VAT returns, and ensuring timely payments. Our comprehensive services encompass these essential aspects to guarantee seamless compliance.
                </div>
              </Collapsible>
              <Collapsible
                open={false}
                arrow={true}
                title={
                  "How does VAT registration for DIFC companies work ?"
                }
              >
                <div>
                DIFC companies must register for VAT if their taxable supplies exceed AED 375,000 annually. You can apply online via the FTA&apos;s portal, providing business details. Upon approval, you receive a Tax Registration Number (TRN) to be VAT-compliant.
                </div>
              </Collapsible>
            ...
            <Collapsible
                open={false}
                arrow={true}
                title={"Can you assist with VAT recovery for DIFC companies ?"}
              >
                <div>
                Yes, we facilitate VAT recovery for DIFC companies by identifying and reclaiming eligible input tax, thereby optimizing their VAT position, and ensuring maximum benefit.
                </div>
              </Collapsible>
            <Collapsible
                open={false}
                arrow={true}
                title={"Does all DIFC companies need to register for VAT ?"}
              >
                <div>
                No, not all DIFC companies need to register for VAT. Registration is mandatory only for those whose taxable supplies and imports exceed AED 375,000 per annum. Companies below this threshold can choose to register voluntarily to claim input tax credits.
                </div>
              </Collapsible>
