...
import style from "./videocard_alreem.module.css";
...
function VideoCard({ imagePath, title, author, position, styles,customclass,url }) {
  ...
  return <>
    {modalOpen && (
      ...
      >
        ...
        <div className={vstyle.containerPopop}>
          {/* Modal content */}
          <ReactPlayer
            url={url?url:"https://www.youtube.com/watch?v=5G8T5uT4wnU"}
            playing={false}
            controls={true}
            width="100%"
            height="100%"
    ...
    <div
      ...
      style={{
        backgroundImage: `url("${imagePath}"), linear-gradient(180deg, rgba(0, 70, 109, 0) 0%, #00466d 100%)`,
        ...styles,
      }}
    >
      <div className={style.videocontentwrapper} data-aos="fade-up">
        <button
