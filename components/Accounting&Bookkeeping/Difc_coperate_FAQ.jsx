          ...
          <div className={`${styles.onlineBookingService_sub} ${styles.faqservice}`}>
            <div className={styles.columns} data-aos="fade-right">
              <Collapsible
                ...
                arrow={true}
                title={
                  "What are the benefits of setting up a business or operating within the DIFC ?"
                }
              >
                <div>
              ...
              >
                <div>
                There is a range of license types in Dubai International Financial Centre (DIFC) including financial, non-financial license, retail and tech licenses. 
                </div>
              </Collapsible>
