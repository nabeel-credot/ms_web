  ...
  return (
    <Container>
      <div className={styles.container} data-aos="fade-up">
        ...
        We have a solid team with expertise in this to assist you in
        </h3>
        <div className={styles.serviceWrap2}>
          <div className={styles.box+" "+styles.marginRight}>
            ...
            Deciding the best legal form suitable for your company
            </div>
          </div>
          ...
          <div className={styles.box+" "+styles.marginRight}>
            ...
            <div className={styles.title}>
            Drafting Business plans and Legal Documents
            </div>
          </div>
          ...
          <div className={styles.box+" "+styles.marginRight}>
            ...
            <div className={styles.title}>
            Liaising with office providers
            </div>
          </div>
          ...
          <div className={styles.box+" "+styles.marginRight}>
            ...
            <div className={styles.title}>
            Dual License application assistance
            </div>
          </div>
        </div>
      </div>
