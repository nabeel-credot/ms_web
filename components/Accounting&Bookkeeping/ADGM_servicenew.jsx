...
function ADGM_servicenew({ heading, detail,showButton,showBorderBottom,heading1,detailsub1,heading2,detailsub2,points,paddingBottom}) {
  ...
  return (
    ...
    <div className={styles.servicediv1} style={{ borderBottom: showBorderBottom ? '1px solid #D9D9D9' : 'none' }}>
      <div className={styles.overview_popup}>
        <div>
      <div className={styles.servicenewTitle} data-aos="fade-right"> {heading}</div>
      <div style={{alignItems:"center",display:"flex"}} data-aos="fade-right"><p className={styles.servicepara}>
        {detail}
      </p></div></div>
...
<path d="M21.8787 13.6213C23.0503 12.4497 23.0503 10.5503 21.8787 9.37868L13.6213 1.12132C12.4497 -0.0502525 10.5503 -0.0502527 9.37868 1.12132L1.12132 9.37868C-0.0502525 10.5503 -0.0502527 12.4497 1.12132 13.6213L9.37868 21.8787C10.5503 23.0503 12.4497 23.0503 13.6213 21.8787L21.8787 13.6213Z" fill="#D4AE31"/>
    ...
    //   </>
      ...
      {showButton && (
        <div className={styles.coperateservicebtn}>
        <button className={styles.settingbtn} onClick={()=>setAppoint(true)}><span>Setting up in Al Reem</span></button></div>
        )}
    </div>
