...
import Section1 from "../components/Accounting&Bookkeeping/ScaleUp_Section1"
...
function business_startup() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Business Scale Up - MS</title>
        <meta name="description" content="Business Scale Up - MS" />
        <link rel="icon" href="/favicon.png" />
      </Head>
      <Navbar color="black" hoverClr="#D4AE31" img1="/images/downArrow.svg" img2="/images/uarrow.svg" />
      <div className={styles.banner_container}>
        <Banner heading={<>Business Scale Up</>}
          ...
          image="/images/scaleUpBg.png" width="631" height="439" />
      </div>
      <Section1 />
