...
import Section1 from "../components/Accounting&Bookkeeping/FBA_Section1"
import Section4 from "../components/Accounting&Bookkeeping/FB_section"
import Section2 from "../components/Accounting&Bookkeeping/FBA_section2"
import Section3 from "../components/Accounting&Bookkeeping/FBA_section4"
import Quote from "../components/Home/Quote"
import Enterprise_services from '../components/Accounting&Bookkeeping/Advisory_services_sec'
...
function business_startup() {
	return (
		<div className={styles.container}>
			<Head>
				<title>Family Business Advisory - MS</title>
				<meta name="description" content="Family Business Advisory - MS" />
				<link rel="icon" href="/favicon.png" />
			</Head>
			<Navbar color="black" hoverClr="#D4AE31" img1="/images/downArrow.svg" img2="/images/uarrow.svg" />
			<div className={styles.banner_container}>
				<Banner heading={<>Family Business Advisory</>}
					...
					image="/images/fbaBg.png" width="631" height="439" />
			</div>
			<Section1 />
