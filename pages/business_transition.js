...
import Section1 from "../components/Accounting&Bookkeeping/Transition_Section1"
import Section2 from "../components/Accounting&Bookkeeping/Lets_talk"
import Section3 from "../components/Accounting&Bookkeeping/Transition_section2 "
...
function business_startup() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Business Transition - MS</title>
        <meta name="description" content="Business Transition - MS" />
        <link rel="icon" href="/favicon.png" />
      </Head>
      <Navbar color="black" hoverClr="#D4AE31" img1="/images/downArrow.svg" img2="/images/uarrow.svg" />
      <div className={styles.banner_container}>
        <Banner heading={<>Business Transition</>}
          ...
          image="/images/transitionBg.png" width="631" height="439" />
      </div>
      <Section1 />
