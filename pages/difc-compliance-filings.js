...
import ADGM_FAQ_Service from "../components/Accounting&Bookkeeping/Difc_compliance_filling_FAQ";
...
import Compliance_Filing from "../components/Accounting&Bookkeeping/compliance_filling"
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://ms-ca.com/difc-compliance-filings"
        />
      ...
      <div  className={styles.banner_container_difccorporate}>
        <Banner
          ...
          height="428"
          //   white={true}
          detail="Our specialized team at DIFC is here to assist you in ensuring your company meets crucial compliance requirements. 
          Failing to adhere to these obligations can lead to substantial penalties. Trust us to keep your business in accordance with 
          the law and mitigate any potential legal consequences."
        />
      ...
      <div>
        ...
        // showBorderBottom={true}
          ...
          detail="Compliance filings is an integral part to fulfil the legal requirements in DIFC. 
          This include annual accounts to data protection renewal which is essential to stay compliant 
          in the vibrant DIFC community. Companies operating in DIFC must annually prepare financial statements, 
          comprising profit and loss accounts, balance sheets, and cash flow statements, following recognized accounting 
          standards. Renewing both licenses and data protection agreements is critical for maintaining legal and operational 
          validity within DIFC. Failure to renew licenses or adhere to data protection requirements can lead to penalties and legal ramifications. Thus, vigilance in tracking renewal dates, following renewal procedures, and maintaining compliance with regulations is important. It's crucial to stay aligned with regulatory changes and amendments to the compliance framework. Employing a specialized team to aid in meeting these obligations, including preparing financial documents and assessing the applicability of Economic Substance Regulations (ESR) notifications and reporting, can ensure ongoing compliance."
           showButton={true}
        />
      </div>
      <Compliance_Filing/>
...
/>
      ...
      title={'for Compliance Filing services in DIFC'} 
      content1={<span>Navigating compliance filings in DIFC alongside our expert team ensures a seamless process. 
        With MS as your trusted advisor in the complicated regulatory landscape of DIFC, our tailored services, spanning precise 
        document preparation to strategic consulting, expedite compliance procedures, allowing businesses to focus on their fundamental 
        strengths. Avoid penalties and stay compliant with the regulatory framework of DIFC with MS. </span>}/>
       </div>
