...
import Banner2 from "../components/Accounting&Bookkeeping/MASDAR_CC_Banner";
...
function enterprise() {
    return (
        <div className={styles.container}>
            <Head>
                <title> MASDAR Incorporation Compliance and corporate services in Abu Dhabi, Dubai, UAE | Corporate Accounts - MS</title>
                <meta name="description" content=" MASDAR Incorporation Compliance and corporate services" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content=" MASDAR Incorporation Compliance and corporate services" />
                <meta property="og:description" content=" MASDAR Incorporation Compliance and corporate services" />
                <meta property="og:url" content="https://ms-ca.com/masdar-incorporation-compliance-and-corporate-services" />
                ...
                <link rel="canonical" href="https://ms-ca.com/masdar-incorporation-compliance-and-corporate-services" />
            ...
            <div className={styles.banner_container_masdar2}>
                <Banner heading={<>MASDAR Incorporation Compliance<br/> and corporate services</>}
            ...
            <div className={styles.marginBt+" "+styles.marginT20}>
                <Section2 service="MASDAR Incorporation Compliance and corporate services" />
            </div>
