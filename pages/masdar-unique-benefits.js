...
import Banner2 from "../components/Accounting&Bookkeeping/MASDAR_UB_Banner";
...
function enterprise() {
    return (
        <div className={styles.container}>
            <Head>
                <title>Management Advisory in Abu Dhabi, Dubai, UAE | Corporate Accounts - MS</title>
                <meta name="description" content="Management Advisory" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content="Management Advisory" />
                <meta property="og:description" content="Management Advisory" />
                <meta property="og:url" content="https://ms-ca.com/masdar-management-advisory" />
                ...
                <link rel="canonical" href="https://ms-ca.com/masdar-management-advisory" />
                <link rel="icon" href="/favicon.png" />
            </Head>
            <Navbar color="#FFFFFF" hoverClr="#D4AE31" img1="/images/darrow.svg" img2="/images/uarrow.svg" />
            <div className={styles.banner_container_masdar3}>
                <Banner heading={<>Unique Benefits</>}
