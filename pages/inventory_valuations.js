...
import Section1 from "../components/Accounting&Bookkeeping/IV_Section1"
...
function business_startup() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Inventory Valuations - MS</title>
        <meta name="description" content="Inventory Valuations - MS" />
        <link rel="icon" href="/favicon.png" />
      </Head>
      <Navbar color="black" hoverClr="#D4AE31" img1="/images/downArrow.svg" img2="/images/uarrow.svg" />
      <div className={styles.banner_container}>
        <Banner heading={<>Inventory Valuations</>}
          ...
          image="/images/inventoryBg.png" width="632" height="412" />
      </div>
      <Section1 />
