...
import Banner2 from "../components/Accounting&Bookkeeping/DMCC_CC_Banner";
...
function enterprise() {
    return (
        <div className={styles.container}>
            <Head>
                <title> DMCC Compliance & Corporate Services in UAE - MS</title>
                <meta name="description" content=" DMCC Compliance & Corporate Services in UAE - MS" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content=" DMCC Compliance & Corporate Services in UAE - MS" />
                <meta property="og:description" content=" DMCC Compliance & Corporate Services in UAE - MS" />
                <meta property="og:url" content="https://ms-ca.com/dmcc-compliance-and-corporate-services" />
                ...
                <link rel="canonical" href="https://ms-ca.com/dmcc-compliance-and-corporate-services" />
            ...
            <div className={styles.banner_container_dmcc2}>
                <Banner heading={<>DMCC Compliance and<br/> Corporate Services</>}
            ...
            <div className={styles.marginBt+" "+styles.marginT20}>
                <Section2 service="DMCC Compliance and Corporate Services" />
            </div>
