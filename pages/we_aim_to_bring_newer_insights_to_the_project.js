...
import Section1 from "../components/Accounting&Bookkeeping/NP_section1"
import Section2 from "../components/Accounting&Bookkeeping/NP_Section2"
  ...
  return (
    <div  className={styles.container}>
      ...
      <div className={styles.banner_container}>
        <Banner heading={<>We aim to bring newer insights to the project.</>}
          ...
          image="/images/npBg.png" width="632" height="412" />
      </div>
      <Section1 />
