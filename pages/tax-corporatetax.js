...
import Y_Tax from "../components/Accounting&Bookkeeping/Why-tax-coperatetax"
    ...
    <div className={styles.container}>
      ...
      <div className={styles.banner_container_accounting}>
        <Banner
          ...
          height="428"
          detail="Our team at MS unveils the new corporate tax realm in UAE for your ease of doing business.  Our tax specialists become an extension of your team, ensuring accurate filings, minimizing liabilities, and maximizing deductions through strategic planning."
        />
      ...
      <div>
        <Overview
          ...
          heading=" Grow Your Business, Not Your Tax Burden"
          detail="Don't let the new corporate tax realm hinder your business growth. Our team of tax specialists in MS is here to simplify the process for you in UAE. The deadlines are nearing for almost all the entities in the UAE, and it is important to make sure you have made the impact assessments and structuring ready. We understand that calculating taxable income, navigating deductions, and staying compliant with ever-evolving regulations can be a time-consuming challenge. Our tax service ensures accurate and complete corporate tax filings, minimizing your risk of penalties. We go beyond just filing – our experts identify all available deductions to reduce your tax burden and provide strategic tax planning advice tailored to your business goals. Let us handle the complexities of UAE Corporate Tax, so you can focus on achieving your entrepreneurial dreams."
           showButton={true}
        />
      </div>
      <Y_Tax/>
      ...
      <Alreem_yMs 
      title={'for Corporate Tax services in the UAE'} 
      content1={<span>Unlocking the full potential of your UAE business starts with navigating the complexities of the UAE Corporate Tax. Our team of dedicated specialists in MS brings unparalleled expertise to the table. We stay updated on the ever-evolving UAE corporate tax regulations, ensuring your filings are accurate and minimize the risk of penalties. But our service goes beyond just compliance. Our tax professionals are well-versed in maximizing deductions and credits specific to your industry and business operations in the UAE. This translates to a significant reduction in your taxable income and overall tax burden.  Forget generic tax plans – we create a customized plan aligned with your specific UAE business goals.
        </span>}/>
       </div>
