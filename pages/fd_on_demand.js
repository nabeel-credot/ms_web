...
import Section1 from "../components/Accounting&Bookkeeping/FD_section1"
import Section2 from "../components/Accounting&Bookkeeping/FD_Section2"
...
function business_startup() {
	return (
		<div className={styles.container}>
			<Head>
				<title>FD on Demand - MS</title>
				<meta name="description" content="FD on Demand - MS" />
				<link rel="icon" href="/favicon.png" />
			</Head>
			<Navbar color="black" hoverClr="#D4AE31" img1="/images/downArrow.svg" img2="/images/uarrow.svg" />
			<div className={styles.banner_container}>
				<Banner heading={<>FD on Demand</>}
					...
					image="/images/fdBg.png" width="632" height="412" />
			</div>
			<Section1 />
