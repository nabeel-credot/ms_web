...
import ADGM_FAQ_Service from "../components/Accounting&Bookkeeping/Esr_FAQ";
...
function ADGM(props) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>
        Professional ESR Services in ADGM | MS
        </title>
        <meta
          name="description"
          content="MS offers ESR services in ADGM to ensure your business meets global standards and avoids penalties. Our guidance helps your business succeed and stay compliant."
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta
          property="og:title"
          content="ESR Services in Abu Dhabi, Dubai, UAE | VAT Consultants - MS"
        />
        <meta
          property="og:description"
          content="MS offers ESR services in ADGM to ensure your business meets global standards and avoids penalties. Our guidance helps your business succeed and stay compliant."
        />
        <meta property="og:url" content="https://ms-ca.com/esr" />
        ...
        <link rel="canonical" href="https://ms-ca.com/esr" />
      ...
      <div className={styles.banner_container_service}>
        <Banner
          heading={<div style={{ fontWeight: "400" }}>Economic Substance Regulation</div>}
          height="428"
          //   white={true}
          detail="The Economic Substance Regulations (ESR) in UAE require businesses to demonstrate their economic activity and ensure it aligns with their presence in the country. Our financial services can assist you in meeting these regulatory requirements."
        />
        {appoint && (
      ...
      <div>
        <Alreem_yMs
          title={"for ESR Services in ADGM?"}
          content1={
          ...
          content2={"Do flawless business with MS. "}
        />
